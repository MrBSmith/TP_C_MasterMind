    ...
    for(int i=0; i<nombre; i++){
        do{
            ...
            if((int)c == 8){ // If the player hit backspace
                if(i > 0){
                    // set the previous value to null, and go back to the previous iteration
                    i--;
...
// Check the placement of each numbers in the player's try
void get_results(int *n_Player_try, int *n_Result, placement *pla_Result){
